// Compatibility implementation backing the domain API modules.
// New frontend API clients should be added under dashboard-v2/src/services/api/<domain>.ts
// and re-exported from dashboard-v2/src/services/api.ts instead of expanding this file.
import type {
  ProjectSummary,
  ProjectDetail,
  SessionRecord,
