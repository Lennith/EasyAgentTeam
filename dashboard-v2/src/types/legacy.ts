// Compatibility type source backing domain type barrels.
// New shared frontend types should be added under dashboard-v2/src/types/<domain>.ts
// and re-exported from dashboard-v2/src/types/index.ts instead of expanding this file.
