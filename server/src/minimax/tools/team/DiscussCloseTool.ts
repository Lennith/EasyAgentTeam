...
export class DiscussCloseTool extends TeamTool {
  get name(): string {
    return "discuss_close";
  }

  get description(): string {
    return "Close discuss thread with final decision/summary.";
  }
  ...
  get parameters(): Record<string, unknown> {
    return {
      ...
      properties: {
        ...
        message: { type: "string", description: "Final close message." },
