...
export function buildProjectMessageRoutingContext(input: {
  dataRoot: string;
...
export async function readRoutingSession(
...
export async function resolveDeliverRoutingTarget(input: ProjectDeliverMessageInput): Promise<{
...
export async function resolveRoutingRole(
  scope: ProjectMessageRoutingContext,
  target: ProjectMessageRoutingTarget
): Promise<string> {
...
export async function resolveTaskDiscussMessageForTargetRole(
  scope: ProjectMessageRoutingContext,
  target: ProjectMessageRoutingTarget,
  message: ManagerToAgentMessage
): Promise<{
...
export async function syncRoleSessionMap(
  scope: ProjectMessageRoutingContext,
  role: string | null,
  sessionId: string
): Promise<void> {
...
export async function appendProjectManagerRouteEvents(
  scope: ProjectMessageRoutingContext,
...
export async function appendProjectTaskAssignmentRouteEvent(
  scope: ProjectMessageRoutingContext,
...
export function buildProjectMessageRouteResult(input: {
...
export function buildProjectTaskAssignmentRouteResult(input: {
...
export const runProjectMessageRoutingInUnitOfWork = createOrchestratorMessageRoutingUnitOfWorkRunner<
  ProjectMessageRoutingContext,
  unknown
